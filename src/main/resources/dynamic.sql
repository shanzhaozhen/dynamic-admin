...
菜单表基础数据
 */
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (1, 'Permission', '/permission', NULL, 'Layout', '/permission/page', '权限控制', 'lock', 1, b'0', b'0', b'0', b'0', b'1', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (2, 'PagePermission', 'page', 1, '/permission/page', NULL, '角色切换', NULL, 1, b'0', b'0', b'0', b'0', b'1', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (3, 'DirectivePermission', 'directive', 1, '/permission/directive', NULL, '权限指令', NULL, 2, b'0', b'0', b'0', b'0', b'1', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (4, 'RoutePermission', 'route', 1, '/permission/page', NULL, '路由管理', NULL, 3, b'0', b'0', b'0', b'0', b'1', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (5, 'ResourcePermission', 'resource', 1, '/permission/resource', NULL, '资源管理', NULL, 4, b'0', b'0', b'0', b'0', b'1', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (6, 'RolePermission', 'role', 1, '/permission/role', NULL, '角色权限', NULL, 5, b'0', b'0', b'0', b'0', b'1', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (7, 'Iframe', '/iframe', NULL, 'Layout', 'noRedirect', '开发者工具', 'link', 99, b'0', b'0', b'0', b'0', b'1', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (8, 'Druid', 'druid', 7, '/iframe/index', NULL, 'Druid', 'link', 1, b'0', b'0', b'0', b'0', b'1', '{ \"redirect\": \"http://localhost:8080/dynamic/druid\" }', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `dynamic`.`sys_route`(`id`, `name`, `path`, `pid`, `redirect`, `title`, `icon`, `priority`, `hidden`, `always_show`, `no_cache`, `affix`, `breadcrumb`, `props`, `description`, `create_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (9, 'Swagger', 'swagger', 7, '/iframe/index', NULL, 'Swagger', 'link', 2, b'0', b'0', b'0', b'0', b'1', '{ \"redirect\": \"http://localhost:8080/dynamic/swagger-ui.html\" }', NULL, NULL, NULL, NULL, NULL);
